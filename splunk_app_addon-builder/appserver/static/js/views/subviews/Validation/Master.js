...
import SplunkMvc from "splunkjs/mvc";
import SplunkTableView from "splunkjs/mvc/tableview";

import TableElement from "splunkjs/mvc/simplexml/element/table";
...
export default BaseSubView.extend({
    ...
    renderSingleValues() {
        ...
        if (
            ...
            _.includes(
                SplunkUtil.stringToFieldList(this.model.get("validators")),
                "app_cert_validation"
            )
        ) {
    ...
    renderColumnChart() {
        this.createPresenter("ruleDistSearch", ColumnChartPresenter, {
            categories: SplunkUtil.stringToFieldList(
                this.model.get("validators")
            ),
