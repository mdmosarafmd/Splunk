...
import solnlib.packages.splunklib.binding as binding
from solnlib.packages.splunklib.client import Input
from solnlib.packages.splunklib.client import Collection
